                ...
                <div class="{{ this.post.featured_media_url['pa-block-render'] ? 'col-5 col-md-4' : 'd-none' }}">
                    <div class="ratio ratio-16x9">
                        <figure class="figure m-xl-0">
                            ...
                            <figcaption *if="{{ this.post.terms.editorial }}" class="pa-img-tag figure-caption text-uppercase rounded-right d-table-cell">{{ this.post.terms.editorial }}</figcaption>
                        </figure>	
                    </div>
                </div>
